...
<div class="login-page">
	<div class="form">
		<form class="login-form" name="form1">
			<a HREF = vistas/vistaPersona.php>Personas</a><br><br>
			<a HREF = vistas/vistaAlumno.php>Alumnos</a><br><br>
			<a HREF = vistas/vistaDocente.php>Docentes</a><br><br>
			...
			<a HREF = consultas/ingresar_alumno.php>Ingresar Alumno</a><br><br>
			<a HREF = consultas/editar_alumno.php>Editar datos de alumno</a><br><br>
			<a HREF = consultas/inscripcion_materia.php>Inscripcion a Materia</a><br><br>
